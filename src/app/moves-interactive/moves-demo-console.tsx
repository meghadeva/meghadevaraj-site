  ...
  return (
    <main className="min-h-screen bg-[#ece6dc] text-[#1c1a17]">
      <section className="mx-auto flex min-h-screen w-full max-w-7xl flex-col gap-5 px-4 py-5 sm:px-6 lg:px-8">
        <header className="rounded-[26px] border border-[#1c1a17]/10 bg-[#fffaf1] p-5 shadow-[0_18px_50px_rgba(62,50,35,0.10)] sm:p-6">
          <div className="grid gap-5">
            <div>
              <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-[#7c6ff7]/20 bg-[#eeedff] px-3 py-1.5 text-sm font-semibold text-[#534ab7]">
              ...
              <h1
                aria-label="moves"
                className="font-serif text-5xl font-semibold tracking-[-0.045em] sm:text-7xl"
              >
                mo
            ...
            >
              {(Object.keys(demos) as DemoKey[]).map((key) => {
                ...
                return (
                  <button
                    ...
                    className={`group flex min-h-14 items-center justify-center gap-2 rounded-xl px-3 py-3 text-sm font-semibold outline-none transition focus-visible:ring-2 focus-visible:ring-[#7c6ff7] ${
                      isActive
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="group flex min-h-14 items-center justify-center gap-2 rounded-xl px-3 py-3 text-sm font-semibold text-[#176c4d] outline-none transition hover:bg-[#e0f7ee] focus-visible:ring-2 focus-visible:ring-[#7c6ff7]"
              >
        ...
        <section className="min-w-0 rounded-[28px] border border-[#1c1a17]/10 bg-[#fffaf1] p-3 shadow-[0_22px_65px_rgba(62,50,35,0.13)]">
          <div className="mb-3 flex items-center justify-between gap-3 px-2 pt-1 text-[#1c1a17]">
            <div className="flex min-w-0 items-center gap-3">
              <span className="grid size-10 shrink-0 place-items-center rounded-xl bg-[#eeedff] text-[#534ab7]">
                <ActiveIcon size={20} aria-hidden="true" />
              </span>
              <div className="min-w-0">
                <h2 className="truncate text-lg font-semibold">{active.title}</h2>
                <p className="truncate text-sm text-[#6f695f]">{active.eyebrow}</p>
              </div>
            </div>
          ...
          <div className="h-[760px] overflow-hidden rounded-[22px] border border-[#1c1a17]/10 bg-[#e8e4dd] shadow-[inset_0_0_0_1px_rgba(255,255,255,0.55)] lg:h-[calc(100vh-220px)] lg:min-h-[620px]">
            <iframe
              key={active.src}
              src={active.src}
